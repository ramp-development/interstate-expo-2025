...
(() => {
  ...
  // node_modules/.pnpm/browser-dtector@3.3.0/node_modules/browser-dtector/browser-dtector.umd.min.js
  var require_browser_dtector_umd_min = __commonJS({
    "node_modules/.pnpm/browser-dtector@3.3.0/node_modules/browser-dtector/browser-dtector.umd.min.js"(exports, module) {
      init_live_reload();
      !function(e, o) {
        ...
        var o = { chrome: "Google Chrome", brave: "Brave", crios: "Google Chrome", edge: "Microsoft Edge", edg: "Microsoft Edge", edgios: "Microsoft Edge", fennec: "Mozilla Firefox", jsdom: "JsDOM", mozilla: "Mozilla Firefox", fxios: "Mozilla Firefox", msie: "Microsoft Internet Explorer", opera: "Opera", opios: "Opera", opr: "Opera", rv: "Microsoft Internet Explorer", safari: "Safari", samsungbrowser: "Samsung Browser", electron: "Electron" }, r = { android: "Android", androidTablet: "Android Tablet", cros: "Chrome OS", fennec: "Android Tablet", ipad: "IPad", iphone: "IPhone", jsdom: "JsDOM", linux: "Linux", mac: "Macintosh", tablet: "Android Tablet", win: "Windows", "windows phone": "Windows Phone", xbox: "Microsoft Xbox" }, n = function(e2) {
          ...
          return a = t2, l = [{ key: "parseUserAgent", value: function(e2) {
            var t3, a2, l2, s2 = {}, c = e2 || this.userAgent || "", d = c.toLowerCase().replace(/\s\s+/g, " "), u = /(edge)\/([\w.]+)/.exec(d) || /(edg)[/]([\w.]+)/.exec(d) || /(opr)[/]([\w.]+)/.exec(d) || /(fxios)[/]([\w.]+)/.exec(d) || /(edgios)[/]([\w.]+)/.exec(d) || /(jsdom)[/]([\w.]+)/.exec(d) || /(samsungbrowser)[/]([\w.]+)/.exec(d) || /(electron)[/]([\w.]+)/.exec(d) || /(chrome)[/]([\w.]+)/.exec(d) || /(crios)[/]([\w.]+)/.exec(d) || /(opios)[/]([\w.]+)/.exec(d) || /(version)(applewebkit)[/]([\w.]+).*(safari)[/]([\w.]+)/.exec(d) || /(webkit)[/]([\w.]+).*(version)[/]([\w.]+).*(safari)[/]([\w.]+)/.exec(d) || /(applewebkit)[/]([\w.]+).*(safari)[/]([\w.]+)/.exec(d) || /(webkit)[/]([\w.]+)/.exec(d) || /(opera)(?:.*version|)[/]([\w.]+)/.exec(d) || /(msie) ([\w.]+)/.exec(d) || /(fennec)[/]([\w.]+)/.exec(d) || d.indexOf("trident") >= 0 && /(rv)(?::| )([\w.]+)/.exec(d) || d.indexOf("compatible") < 0 && /(mozilla)(?:.*? rv:([\w.]+)|)/.exec(d) || [], f = /(ipad)/.exec(d) || /(ipod)/.exec(d) || /(iphone)/.exec(d) || /(jsdom)/.exec(d) || /(windows phone)/.exec(d) || /(xbox)/.exec(d) || /(win)/.exec(d) || /(tablet)/.exec(d) || /(android)/.test(d) && false === /(mobile)/.test(d) && ["androidTablet"] || /(android)/.exec(d) || /(mac)/.exec(d) || /(linux)/.exec(d) || /(cros)/.exec(d) || [], p = u[5] || u[3] || u[1] || null, w = f[0] || null, x = u[4] || u[2] || null, b = i();
  ...
  var ScrollTrigger2 = /* @__PURE__ */ function() {
    ...
    _proto.init = function init4(vars, animation) {
      ...
      !animation || !animation.add || change ? self2.refresh() : gsap4.delayedCall(0.01, function() {
  ...
  var _deWordify = function _deWordify2(e) {
    var children = _toArray3(e.childNodes), l = children.length, i, child;
    for (i = 0; i < l; i++) {
      child = children[i];
      if (child._isSplit) {
        _deWordify2(child);
  ...
  var _split = function _split2(element, vars, wordStart, charStart) {
    var children = _toArray3(element.childNodes), l = children.length, absolute = _isAbsolute(vars), i, child;
  ...
  // src/animations/utils/slideUp.ts
  init_live_reload();

  // src/animations/utils/slideUpChildren.ts
  init_live_reload();

  // src/animations/utils/splitChars.ts
  init_live_reload();

  // src/animations/utils/broswer.ts
  init_live_reload();

  // src/utils/detectBroswer.ts
  init_live_reload();
  ...
  // src/animations/utils/splitWords.ts
  init_live_reload();

  // src/animations/groups.ts
  var groups = () => {
    const defaults2 = { duration: 1, ease: "power2.out", stagger: 0.1 };
    let start = "top 60%";
    const onload = (self2) => self2.progress === 1 && self2.animation.progress(1);
    const onRefresh = (self2) => self2.progress === 1 && self2.animation.progress(1);
    const attr = "data-animation-element";
    const groups2 = queryElements(`[${attr}="group"]`);
    groups2.forEach((group) => {
      const trigger = group.dataset.animationTrigger;
      if (trigger)
        start = trigger;
      const title = queryElement(`[${attr}="title"]`, group);
      const buttonGroup = queryElement(`[${attr}="button-group"]`, group);
      ...
      if (title)
        splitLines(title, timeline2, "0");
      if (buttonGroup)
        buttons(buttonGroup, timeline2, "-=50%");
    });
  };

  // src/animations/mouse.ts
  init_live_reload();
  var mouse = () => {
    const mouse2 = queryElement(".mouse-cursor");
    if (!mouse2)
      return;
    const mouseText = queryElement('[data-mouse="text"]', mouse2);
    const elements = queryElements("a, [href], [data-mouse-class]");
    elements.forEach((element) => {
      ...
      element.addEventListener("mouseenter", () => {
        ...
        mouse2.classList.add(cursorClass);
      });
      element.addEventListener("mouseleave", () => {
        mouse2.classList.remove(cursorClass);
      });
    });
  };
  ...
  var nav = () => {
    ...
    const nav3 = queryElement(".nav_component");
    if (!nav3)
      return;
    if (window.scrollY >= 128)
      nav3.classList.add(scrollClass);
    window.addEventListener("scroll", () => {
      if (window.scrollY >= 128)
        nav3.classList.add(scrollClass);
      if (window.scrollY < 128)
        nav3.classList.remove(scrollClass);
    });
  };
  ...
  var transitions = () => {
    ...
    const trigger = queryElement(`[${attr}=trigger]`);
    if (!trigger)
      return;
  ...
  // src/utils/getActiveLink.ts
  init_live_reload();
  var getActiveLink = (links) => {
  ...
  var nav2 = () => {
    ...
    if (!nav3)
      return;
    const mouse2 = queryElement(".mouse");
    const navMenuButton = queryElement(".nav_menu-btn", nav3);
  ...
  var cases = () => {
    console.log("cases");
    const component = queryElement(".cases");
    if (!component)
      return;
    const track = queryElement(".cases-track", component);
    const cases2 = queryElements(".cases-item", component);
    if (!track || !cases2)
      return;
    const length = (cases2.length - 2) * cases2[0].offsetWidth;
  ...
  // node_modules/.pnpm/@finsweet+ts-utils@0.39.0/node_modules/@finsweet/ts-utils/dist/helpers/index.js
  init_live_reload();
  ...
  // node_modules/.pnpm/file+gsap-bonus.tgz/node_modules/gsap/CustomEase.js
  init_live_reload();
  ...
  function rawPathToString(rawPath) {
    ...
    for (s = 0; s < l; s++) {
      ...
      sl = segment.length;
      for (i = 2; i < sl; i++) {
        result += _round7(segment[i++]) + "," + _round7(segment[i++]) + " " + _round7(segment[i++]) + "," + _round7(segment[i++]) + " " + _round7(segment[i++]) + "," + _round7(segment[i]) + " ";
      }
      if (segment.closed) {
        result += "z";
      }
  ...
  var _initCore7 = function _initCore8() {
    gsap6 = _getGSAP5();
    if (gsap6) {
      gsap6.registerEase("_CE", CustomEase.create);
      _coreInitted5 = 1;
    } else {
  ...
  var CustomEase = /* @__PURE__ */ function() {
    function CustomEase2(id, data, config3) {
      ...
      this.id = id;
      _bonusValidated2 && this.setData(data, config3);
    }
    ...
    _proto.setData = function setData(data, config3) {
      ...
      this.id && gsap6 && gsap6.registerEase(this.id, this.ease);
      return this;
    };
    ...
    CustomEase2.get = function get(id) {
      return gsap6.parseEase(id);
    };
    CustomEase2.getSVGData = function getSVGData(ease, config3) {
      config3 = config3 || {};
      var width = config3.width || 100, height = config3.height || 100, x = config3.x || 0, y = (config3.y || 0) + height, e = gsap6.utils.toArray(config3.path)[0], a, slope, i, inc, tx, ty, precision, threshold, prevX, prevY;
      if (config3.invert) {
        height = -height;
        y = 0;
      }
      if (typeof ease === "string") {
        ease = gsap6.parseEase(ease);
      }
      if (ease.custom) {
        ease = ease.custom;
      }
      if (ease instanceof CustomEase2) {
        ...
        prevX = _round9(x + inc * width);
        prevY = _round9(y + ease(inc) * -height);
        slope = (prevY - y) / (prevX - x);
        for (i = 2; i < precision; i++) {
          tx = _round9(x + i * inc * width);
          ty = _round9(y + ease(i * inc) * -height);
  ...
  _getGSAP5() && gsap6.registerPlugin(CustomEase);
  ...
  var home = () => {
    ...
    const wrapper = queryElement(`[${revealAttribute}="wrapper"]`);
    const transitionEl = queryElement(`[${revealAttribute}="transition"]`, wrapper);
    const loaderEl = queryElement(`[${revealAttribute}="loader"]`, wrapper);
    const close = queryElement(`[${revealAttribute}="close"]`, wrapper);
    ...
    function loader() {
      if (transitionEl)
        transitionEl.remove();
      const customEase = "M0,0,C0.061,0.186,0.198,0.488,0.482,0.568,0.564,0.591,0.741,0.561,0.882,0.668,1.009,0.765,0.986,1,1,1";
      const counter = { value: 0 };
      let duration = 6;
      const attr = "data-loader";
      const loaderText = queryElement(`[${attr}="text"]`);
      const loaderBackground = queryElement(`[${attr}="background"]`);
      if (!loaderText || !loaderBackground)
        return;
